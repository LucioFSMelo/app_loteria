...
def home():
    ...
    print('*'*60)
    print('')
    print(f'A Probabilidade de acertar na Mega Sena é {combinac_6}')
    print('')
    print(f'O valor a pagar por um jogo de 6 dezenas é {preco}')
    print('')
    print(f'Quantidades de combinações em um bilhete de {quant_combinc[1]} números é {quant_combinc[0]} combinações.')
    print('')
    print(f'O valor a pagar por um jogo de {quant_combinc[1]} dezenas é {preco*quant_combinc[0]}')
    print('')
    print(f'A Probabilidade de acertar na Mega Sena com um jogo de {quant_combinc[1]} dezenas é {quant_combinc[0]}')
    print('--*--'*12)
    print('*'*60)
